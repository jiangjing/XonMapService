...
class gsp_XonMapService_layoutsmain_gsp extends GroovyPage {
...
printHtmlPart(4)
invokeTag('message','g',14,['code':("spinner.alt"),'default':("Loading&hellip;")],-1)
printHtmlPart(5)
})
...
public static final long LAST_MODIFIED = 1430124394000L
